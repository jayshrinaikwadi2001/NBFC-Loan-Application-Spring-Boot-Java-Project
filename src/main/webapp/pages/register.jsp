...
<form class="form-inline my-2 my-lg-0">
    <a href="SigninSignup" class="btn btn-info my-2 my-sm-0 text-uppercase mr-2">Login</a>
    <a href="SigninSignup" class="btn btn-info my-2 my-sm-0 text-uppercase">Register</a>
</form>
                    ...
                    <div class="card-body p-md-5">
                        <div class="row justify-content-center">
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Let's Create Your Account</p>
                                <form  action="storedata" method="post" class="mx-1 mx-md-4" style="color: #555;">

                                    <div class="mb-3">
                                        <label for="form3Example1c" class="form-label">Full Name</label>
                                        <input type="text" id="form3Example1c" class="form-control" name="name" style="border-color: black; border-radius: 10px;" />
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <label for="form3Example4cd" class="form-label">Confirm Password</label>
                                        <input type="password" id="form3Example4cd" class="form-control" name="cpass" style="border-color: black; border-radius: 10px;" />
                                    </div>

                                    <div class="d-grid gap-2 mb-3">
                                        <button type="submit" class="btn btn-primary btn-lg" style="background-color: #8B4513; border: none; border-radius: 10px;">Register</button>
                                    </div>

                                    <div style="text-align: center;">
                                        <span style="color: #888;">Already Have an Account? </span>
                                        <a href="login" style="color: #8B4513; text-decoration: none; font-weight: bold;">Login here</a>
                                    </div>
                                </form>
                            </div>
