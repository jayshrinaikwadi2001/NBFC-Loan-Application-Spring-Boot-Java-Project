...
<div class="container mt-5">
    <div class="row align-items-center">
        <div class="col-md-6 text-section">
            ...
            <h1 id="personal loan" style="font-size: 60px;  font-weight: bold;">Invest with Confidence, Grow with Us.</h1>

           
            <p>Business loan is a financial instrument that can be used to cover both unexpected and 
                anticipated expenses. A business loan loan is borrowed money that businesses use to cover costs they can't afford on their own in the short term. Loans are not provided without charge.
                ...
                Business loans are of great help in meeting working capital requirements and expanding the business.
            </p>
        ...
        <div class="col-md-6 image-section">
            ...
            <img class="image-overlay" src="images/b2.jpg" alt="Overlay Image">
            <!-- Overlay image with slight overlap -->
            <img class="background-image" src="images/b3.jpg" alt="Background Image">
        </div>
    </div>
</div>
