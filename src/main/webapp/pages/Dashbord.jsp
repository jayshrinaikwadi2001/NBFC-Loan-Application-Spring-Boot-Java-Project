...
<div class="container">
    <div class="row">
        <div class="col-md-6" style="margin-bottom: 20px;">
            <form id="loanForm1" action="" method="post" novalidate>
                <div class="form-group">
                   
                    <input type="hidden" class="form-control" id="aemail" name="aemail" value="<%HttpSession s1=request.getSession(false); out.println(s1.getAttribute("temp1"));%>" required readonly>
                ...
                <div class="container mt-5">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="loan-card">
                                <img src="/images/dash-1.jpeg" alt="Approved Loan" style="width: 100%; height: 100%; object-fit: cover;">
                            </div>
                        </div>
                    </div>
                </div>
                <button type="submit" class="btn btn-primary custom-button">
                    <a href="Approved/${temp1}" style="text-decoration: none; color: inherit; display: inline-block;">
                        View Approved Loan
                    </a>
                </button>
            </form>
        ...
        <div class="col-md-6">
            <form id="loanForm2" action="" method="post" novalidate>
                <div class="form-group">
                ...
                <div class="container mt-5">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="loan-card">
                                <img src="/images/dash-2.jpeg" alt="Applied Loans" style="width: 100%; height: 100%; object-fit: cover;">
                            </div>
                        </div>
                    </div>
                </div>
                <button type="submit" class="btn btn-primary custom-button">
                    <a href="Applied/${temp1}" style="text-decoration: none; color: inherit; display: inline-block;">
                       View Applied Loans 
                    </a>
                </button>
            </form>
